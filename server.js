...
new Moonboots({
    moonboots: {
        jsFileName: 'ampersandexample',
        cssFileName: 'ampersandexample',
...
console.log("AmpersandExample is running at: http://localhost:" + config.http.port + " Yep. That\'s pretty awesome.");
